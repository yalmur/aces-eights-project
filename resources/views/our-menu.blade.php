        ...
        <div class="{{ $isPizza ? 'pizza-grid' : '' }}">
            ...
            <div class="menu-item">
                ...
                <button class="menu-item-btn"
                        @click="$store.cart.openDrawer({ id: {{ json_encode($item['id']) }}, name: {{ json_encode($item['name']) }}, category: {{ json_encode($item['category']) }}, basePrice: {{ $item['basePrice'] }}, allergens: {{ json_encode($item['allergens']) }}, image: {{ json_encode($item['image']) }}, ingredients: {{ json_encode($item['ingredients']) }}, relatedItems: {{ json_encode($item['relatedItems']) }}, isCustomizable: {{ json_encode($item['isCustomizable']) }}, availableToppings: {{ json_encode($item['availableToppings']) }} })"
